...
class Drivetrain:
    ...
    def __init__(self) -> None:
        ...
        self.frontLeft = swervemodule.SwerveModule(11, 2, 9)
        self.frontRight = swervemodule.SwerveModule(3, 4, 10)
        self.backRight = swervemodule.SwerveModule(5, 6, 12)
        self.backLeft = swervemodule.SwerveModule(7, 8, 13)
